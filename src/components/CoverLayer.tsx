...
const CoverLayer: React.FC<{ onEnter: () => void }> = ({ onEnter }) => {
  ...
  return (
    <motion.div
      ...
      style={{
        backgroundImage: 'url(public/assets/ocean.jpg)',
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            theme === 'dark'
              ? 'linear-gradient(135deg, rgba(26, 41, 63, 0.35) 0%, rgba(16, 33, 52, 0.4) 50%, rgba(10, 20, 40, 0.35) 100%)'
              : 'linear-gradient(135deg, rgba(26, 41, 63, 0.3) 0%, rgba(16, 33, 52, 0.35) 50%, rgba(26, 41, 63, 0.3) 100%)'
        }}
      />
      ...
      >
        ...
        <motion.div
          ...
          style={{
            color: colors.lightText,
            textShadow: '2px 2px 15px rgba(0,0,0,0.35)'
          }}
        >
          {displayedText}
          <span
      ...
      <div
        className="absolute top-0 left-0 w-48 h-48 sm:w-64 sm:h-64 rounded-full blur-3xl"
        style={{ backgroundColor: 'rgba(137, 111, 61, 0.15)' }}
      />
      <div
        className="absolute bottom-0 right-0 w-64 h-64 sm:w-96 sm:h-96 rounded-full blur-3xl"
        style={{ backgroundColor: 'rgba(64, 71, 81, 0.15)' }}
      />
    </motion.div>
  );
};
