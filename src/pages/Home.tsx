...
const Home: React.FC<{ onNavigate: (page: PageType) => void }> = ({ onNavigate }) => {
      ...
      <div className="min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center w-full">
          ...
          <motion.div
            ...
            <button onClick={() => onNavigate('relief')}
              ...
              style={{ backgroundColor: colors.gold, color: theme === 'dark' ? DARK_COLORS.lightText : LIGHT_COLORS.lightBg }}>
              Find Relief 🌊
            </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          {FEATURES.map((feature, i) => (
            <motion.div key={i}
              ...
              <h3 className="text-2xl font-bold mb-3" style={{ color: theme === 'dark' ? colors.lightText : colors.darkText }}>
                {feature.title}
              </h3>
